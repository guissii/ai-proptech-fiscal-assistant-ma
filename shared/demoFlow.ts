...
export const DEMO_NODES: Record<string, DemoNode> = {
  ...
  "q.salarie": {
    ...
    options: [
      ...
      { label: "Non", value: "no", next: "q.portfolioHasProperties" },
    ],
  },
  ...
  "q.salaryMonthly": {
    ...
    number: {
      ...
      next: "q.portfolioHasProperties",
    },
  },

  "q.portfolioHasProperties": {
    id: "q.portfolioHasProperties",
    type: "choice",
    prompt: "Avez-vous déjà d’autres biens immobiliers (en dehors de ce projet) ?",
    options: [
      { label: "0 bien", value: "none", next: "q.otherTaxableIncomeAnnual" },
      { label: "1+ biens", value: "some", next: "q.portfolioCount" },
    ],
  },
  ...
  "q.portfolioCount": {
    id: "q.portfolioCount",
    type: "number",
    prompt: "Combien de biens immobiliers possédez-vous actuellement ?",
    number: {
      min: 0,
      max: 100,
      step: 1,
      unit: "biens",
      placeholder: "Ex: 2",
      next: "q.portfolioTotalValue",
    },
  },

  "q.portfolioTotalValue": {
    id: "q.portfolioTotalValue",
    type: "number",
    prompt: "Valeur totale approximative de vos biens actuels (DH) ?",
    number: {
      min: 0,
      max: 500000000,
      step: 10000,
      ...
      next: "q.portfolioExistingLoansMonthly",
    },
  },

  "q.portfolioExistingLoansMonthly": {
    id: "q.portfolioExistingLoansMonthly",
    type: "number",
    prompt: "Total des mensualités de crédits en cours (tous biens) (DH/mois) ?",
    number: {
      min: 0,
      max: 2000000,
      step: 200,
      unit: "DH/mois",
      placeholder: "Ex: 6000",
      next: "q.otherTaxableIncomeAnnual",
    },
  },

  "q.otherTaxableIncomeAnnual": {
    id: "q.otherTaxableIncomeAnnual",
    type: "number",
    prompt: "Autres revenus imposables annuels (hors salaire, hors ce projet) (DH/an) ?",
    number: {
      min: 0,
      max: 500000000,
      step: 5000,
  ...
  "q.editWhich": {
    ...
    options: [
      ...
      { label: "Biens existants (0/1+)", value: "q.portfolioHasProperties", next: "q.portfolioHasProperties" },
      { label: "Nombre de biens", value: "q.portfolioCount", next: "q.portfolioCount" },
      { label: "Valeur totale des biens", value: "q.portfolioTotalValue", next: "q.portfolioTotalValue" },
      { label: "Mensualités crédits existants", value: "q.portfolioExistingLoansMonthly", next: "q.portfolioExistingLoansMonthly" },
      { label: "Autres revenus annuels", value: "q.otherTaxableIncomeAnnual", next: "q.otherTaxableIncomeAnnual" },
  ...
  "q.done": {
    ...
    action: {
      ...
      inputMap: {
        ...
        portfolioHasProperties: "q.portfolioHasProperties",
        portfolioCount: "q.portfolioCount",
        portfolioTotalValue: "q.portfolioTotalValue",
        portfolioExistingLoansMonthly: "q.portfolioExistingLoansMonthly",
        otherTaxableIncomeAnnual: "q.otherTaxableIncomeAnnual",
